...
def plot_relu():
    ...
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of relu', random_fname=True, figsize=(5, 2.5))
...
def plot_leaky_relu():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of leaky relu', random_fname=True, figsize=(5, 2.5))
...
def plot_elu():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of elu', random_fname=True, figsize=(5, 2.5))
...
def plot_swish():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of swish', random_fname=True, figsize=(5, 2.5))
...
def plot_softplus():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of softplus', random_fname=True, figsize=(5, 2.5))
...
def plot_sigmoid():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of sigmoid', random_fname=True, figsize=(5, 2.5))
...
def plot_tanh():
    ...
    y.backward(Tensor.ones_like(x))
    plot(x.numpy(), x.grad.numpy(), 'x', 'grad of tanh', random_fname=True, figsize=(5, 2.5))
